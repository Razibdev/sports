...
<?php  
 ...
 $query = "SELECT * FROM kabadi ORDER BY kabadi_id desc LIMIT 10";  
 ...
 ?> 
    ...
    <section class="football-section clearfix">
          <div class="row heading-title">
              <h1>Kabadi details</h1>
         </div>
        <div class="row football-wrapper">
                  
                     <label for="football">Kabadi : </label>  
...
$(document).ready(function(){  
           ...
           $('#filter').click(function(){  
                ...
                {  
                     $.ajax({  
                          url:"spfile/kabadi.php",  
                          method:"POST",  
                          data:{from_date:from_date},  
                          success:function(data)  
                          {  
                               $('.kabadi-summary').html(data);  
                          }  
                     });  
                }  
                else  
