...
<?php  
 ...
 $query = "SELECT * FROM cricket ORDER BY c_id desc LIMIT 10";  
 ...
 ?> 
    ...
    <section class="cricket-section clearfix">
          <div class="row heading-title">
              <h1>cricket details</h1>
         </div>
        <div class="row cricket-wrapper">
...
$(document).ready(function(){  
           ...
           $('#filter').click(function(){  
                ...
                {  
                     $.ajax({  
                          url:"spfile/cricket.php",  
                          method:"POST",  
                          data:{from_date:from_date},  
                          success:function(data)  
                          {  
                               $('.cricket-summary').html(data);  
                          }  
                     });  
                }  
                else  
