...
<?php  
 ...
 $query = "SELECT * FROM basketball ORDER BY bas_id desc LIMIT 10";  
 ...
 ?> 
    ...
    <section class="basket-section clearfix">
          <div class="row heading-title">
              <h1>basketball details</h1>
         </div>
        <div class="row basket-wrapper">
        <label for="volley">Basketball : </label>
            <select id="from_date" name="from_date" class="form-control">
                ...
                <div class="basket-summary">
                    <table class="basket-table">
                     ...
                     ?>  
                          <tr>  
                               <td><?php echo $row["bas_id"]; ?></td>  
                               <td><?php echo $row["bas_team"]; ?></td>  
                               <td><?php echo $row["dates"]; ?></td>  
                               <td><?php echo date('g:i A', strtotime($row["times"])); ?></td>  
                               <td> <?php echo $row["bas_result"]; ?></td>  
                          </tr>  
                     <?php  
                     }  
                     ?>  
