    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Football Tournament
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Football Tournament
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_cat = "insert into football (Team,date,result,dates,times) values ('$team','$tournament','$result', '$dates', '$times')";
              ...
              if($run_cat){
                  ...
                  echo "<script>window.open('index.php?view_football','_self')</script>";
