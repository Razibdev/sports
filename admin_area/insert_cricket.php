    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Cricket Tournament
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Cricket Tournament
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_cat = "insert into cricket (c_team,c_date,c_result, dates, times) values ('$team','$tournament','$result', '$dates', '$times')";
              ...
              if($run_cat){
                  ...
                  echo "<script>window.open('index.php?view_cricket','_self')</script>";
...
<?php
  ...
  echo "<script>alert('Your are not supper admin or cricket')</script>";
