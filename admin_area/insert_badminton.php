    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Badminton Tournament
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Badminton Tournament
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_cat = "insert into badminton (bad_team,bad_date,bad_result, dates, times) values ('$team','$tournament','$result', '$dates', '$times')";
